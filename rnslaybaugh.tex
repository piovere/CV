...
\address{slaybaugh@berkeley.edu \\ (570)~$\cdot$~850~$\cdot$~3385} % Your phone number and email
...
\item Research based in numerical methods for neutral particle transport with an emphasis on supercomputing
